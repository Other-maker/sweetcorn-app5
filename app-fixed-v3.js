...
function initializeApp() {
    ...
    updateTodayCash(); // FIXED: Update cash on load
    updateReports();
...
// ============================================
// CASH TRACKING - FIXED: Only fulfilled orders
// ============================================

function updateTodayCash() {
    const today = getTodayDateString();
    // FIXED: Only count FULFILLED cash orders
    const cash = orders
...
function saveOrder() {
    ...
    // NOTE: Cash NOT updated here - only when order fulfilled
...
function cancelOrderInline(orderNumber) {
    if (confirm('Delete this order?')) {
        ...
        // FIXED: Update cash after cancellation
        updateTodayCash();
...
function updateReports() {
    ...
    // FIXED: Only fulfilled orders counted in reports
